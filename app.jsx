...
function App() {
  ...
  const [settings, setSettings] = useState({
    ...
    tone: "pro",
    rules: "1. Sign-off: Team Bar Sumac.\n2. Languages: Dutch and English. Always reply in the language of the review. Reviews in another language are answered in English.\n3. Ratings: Only 4 and 5 star reviews are auto-replied. 1, 2 and 3 star reviews are flagged to the team to answer personally.\n4. Tone: Warm, modern neighbourhood restaurant tone, generous and grounded, never stiff. Keep replies personal and direct, with a relaxed Mediterranean feel only when it reads naturally. Do not sound overly formal, touristy, or generic.\n5. Greeting: Guest name is filled in automatically. Dutch: Beste {name}. English: Hi {name}.\n6. Length: Short and to the point. No long paragraphs. Always end every reply with a period.\n7. Specific mentions: Mention maximum one specific point and only when it reads naturally. Refer to dinner, drinks, the team, the kitchen or the terrace only when the guest brings it up. Food compliments go to the kitchen team.\n8. Emojis: Never, unless the review itself is very informal and uses an emoji. Then one matching emoji is fine.\n9. Never say or promise: Never mention or compare to other venues or competitors. Never promise refunds, free items, vouchers or compensation. Never invent details such as dishes, prices or events that are not in the review. Stay calm and never defensive when a review contains criticism.\n10. Feedback on pricing: If it feels natural, thank them for their feedback. Do not go into detailed explanations or discussions about pricing.",
        ...
        <div className="page">
          <div className="page-head">
            <div>
              ...
              <div className="page-sub">SOUS drafts, checks, and sends review replies based on your rules.</div>
            </div>
          </div>
